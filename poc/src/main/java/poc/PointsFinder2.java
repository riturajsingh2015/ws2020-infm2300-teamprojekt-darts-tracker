...
public class PointsFinder2 {
    ...
    public PointsFinder2(Point middle,  int radius) {
    ...
    public static void main(String[] args) {
        try {
            // Halbe Entfernung von einem äußeren Doubledraht zum gegenüberliegenden äußeren Doubledraht 340,0 mm = 170mm
            PointsFinder2 pointsFinder = new PointsFinder2(new Point(851,851), 642);

            System.out.println(pointsFinder.getPointsFromXYCoordinates(1372, 850)); // 6
            System.out.println(pointsFinder.getPointsFromXYCoordinates(865, 850)); // bulls eye
            System.out.println(pointsFinder.getPointsFromXYCoordinates(890, 850)); // bull
            System.out.println(pointsFinder.getPointsFromXYCoordinates(1480, 850)); // double 6
            System.out.println(pointsFinder.getPointsFromXYCoordinates(1240, 850)); // triple 6
        }
        catch (Exception e) {
    ...
    public int getPointsFromXYCoordinates(int x, int y) {
        ...
        long angle = Math.floorMod((Math.round(theta + 360 - (90 - SEGMENT_ANGLE / 2))), 360);
